...
pub enum LedgerError {
    #[error("HC app not open on Ledger device")]
    ...
    #[error("Ledger received invalid HC message")]
    HUIONEInvalidMessage = 0x6a80,

    #[error("Ledger received message with invalid header")]
    HUIONEInvalidMessageHeader = 0x6a81,

    #[error("Ledger received message in invalid format")]
    HUIONEInvalidMessageFormat = 0x6a82,

    #[error("Ledger received message with invalid size")]
    HUIONEInvalidMessageSize = 0x6a83,

    #[error("HC summary finalization failed on Ledger device")]
    HUIONESummaryFinalizeFailed = 0x6f00,

    #[error("HC summary update failed on Ledger device")]
    HUIONESummaryUpdateFailed = 0x6f01,
