#[allow(deprecated)]
use huione_sdk::sysvar::recent_blockhashes;
use {
...
#[frozen_abi(digest = "FLMgyGcWhpxE5S77uzCijzcNYjwhHNHamXwKjFohkCkd")]
...
impl BlockhashQueue {
    ...
    pub fn get_lamports_per_signature(&self, hash: &Hash) -> Option<u128> {
        self.ages
            .get(hash)
    ...
    pub fn genesis_hash(&mut self, hash: &Hash, lamports_per_signature: u128) {
        self.ages.insert(
            *hash,
            HashAge {
    ...
    pub fn register_hash(&mut self, hash: &Hash, lamports_per_signature: u128) {
...
mod tests {
    #[allow(deprecated)]
    use huione_sdk::sysvar::recent_blockhashes::IterItem;
    use {
        super::*,
        bincode::serialize,
        huione_sdk::{clock::MAX_RECENT_BLOCKHASHES, hash::hash},
    };
