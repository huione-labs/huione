...
impl PrioritizationFeeCache {
    ...
    pub fn get_prioritization_fees(&self, account_keys: &[Pubkey]) -> HashMap<Slot, u128> {
        self.cache
            .read()
            .unwrap()
            .iter()
...
mod tests {
    ...
    fn hashmap_of(vec: Vec<(Slot, u128)>) -> HashMap<Slot, u128> {
    ...
    fn test_get_prioritization_fees() {
        ...
        let collector = huione_sdk::pubkey::new_rand();
        ...
        // Assert after add one transaction for slot 3
        {
            ...
            // before block is marked as completed
            assert_eq!(
                hashmap_of(vec![(2, 3u128), (1, 1u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[]),
            );
            assert_eq!(
                hashmap_of(vec![(2, 3u128), (1, 2u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_a]),
            );
            assert_eq!(
                hashmap_of(vec![(2, 4u128), (1, 2u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_b]),
            );
            assert_eq!(
                hashmap_of(vec![(2, 4u128), (1, 1u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_c]),
            );
            assert_eq!(
                hashmap_of(vec![(2, 4u128), (1, 2u128)]),
            ...
            assert_eq!(
                hashmap_of(vec![(3, 5u128), (2, 3u128), (1, 1u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[]),
            );
            assert_eq!(
                hashmap_of(vec![(3, 6u128), (2, 3u128), (1, 2u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_a]),
            );
            assert_eq!(
                hashmap_of(vec![(3, 5u128), (2, 4u128), (1, 2u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_b]),
            );
            assert_eq!(
                hashmap_of(vec![(3, 6u128), (2, 4u128), (1, 1u128)]),
                prioritization_fee_cache.get_prioritization_fees(&[write_account_c]),
            );
            assert_eq!(
                hashmap_of(vec![(3, 6u128), (2, 4u128), (1, 2u128)]),
                prioritization_fee_cache
                    .get_prioritization_fees(&[write_account_a, write_account_b]),
            );
            assert_eq!(
