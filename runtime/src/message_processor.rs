...
impl ::huione_frozen_abi::abi_example::AbiExample for MessageProcessor {
    fn example() -> Self {
...
mod tests {
    use {
        ...
        huione_program_runtime::{declare_process_instruction, loaded_programs::LoadedProgram},
        huione_sdk::{
    ...
    fn test_process_message_readonly_handling() {
        ...
        enum MockSystemInstruction {
            Correct,
            TransferLamports { lamports: u128 },
            ChangeData { data: u8 },
        }
