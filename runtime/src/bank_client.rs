...
impl SyncClient for BankClient {
    ...
    fn get_balance(&self, pubkey: &Pubkey) -> Result<u128> {
    ...
    fn get_minimum_balance_for_rent_exemption(&self, data_len: usize) -> Result<u128> {
    ...
    fn poll_for_signature_confirmation(
        ...
        // https://github.com/huione-labs/huione/issues/7199
    ...
    fn get_fee_for_message(&self, message: &Message) -> Result<u128> {
...
impl BankClient {
    ...
    pub fn new_shared(bank: &Arc<Bank>) -> Self {
        ...
        let bank = bank.clone();
        Builder::new()
            .name("huioneBankClient".to_string())
...
mod tests {
    ...
    fn test_bank_client_new_with_keypairs() {
        let (genesis_config, john_doe_keypair) = create_genesis_config(hc_to_lamports("1.0"));
