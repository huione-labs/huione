...
enum RentResult {
    ...
    CollectRent {
        ...
        rent_due: u128, // lamports, could be 0
    },
}
...
mod tests {
    use {
        super::*,
        huione_sdk::{account::Account, sysvar},
    };
    ...
    fn test_calculate_rent_result() {
        for set_exempt_rent_epoch_max in [false, true] {
            ...
            assert!(matches!(
                ...
                RentResult::CollectRent{new_rent_epoch:1, rent_due:2 }
            ));
            {
            ...
            let filler_account = huione_sdk::pubkey::new_rand();
