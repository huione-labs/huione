...
pub struct BankIncrementalSnapshotPersistence {
    ...
    pub incremental_capitalization: u128,
}
...
impl<'a, C> huione_frozen_abi::abi_example::IgnoreAsHelper for SerializableAccountsDb<'a, C> {}
...
fn reconstruct_accountsdb_from_fields<E>(
    ...
    capitalizations: (u128, Option<u128>),
    incremental_snapshot_persistence: Option<&BankIncrementalSnapshotPersistence>,
    ...
    E: SerializableStorage + std::marker::Sync,
{
    ...
    let handle = Builder::new()
        .name("huioneNfyAccRestor".to_string())
        .spawn(move || {
