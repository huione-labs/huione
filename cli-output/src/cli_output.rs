use {
    ...
    huione_clap_utils::keypair::SignOnly,
    huione_rpc_client_api::response::{
...
impl OutputFormat {
    ...
    pub fn from_matches(matches: &ArgMatches<'_>, outhuione_name: &str, verbose: bool) -> Self {
        matches
            .value_of(outhuione_name)
...
pub struct CliValidatorsStakeByVersion {
    ...
    pub current_active_stake: u128,
    pub delinquent_active_stake: u128,
}
...
pub struct CliValidators {
    ...
    pub total_current_stake: u128,
    pub total_delinquent_stake: u128,
...
pub struct CliValidator {
    ...
    pub last_vote: u64,
    pub root_slot: u64,
    pub credits: u128,       // lifetime credits
    pub epoch_credits: u128, // credits earned in the current epoch
    pub activated_stake: u128,
...
pub struct CliNonceAccount {
    pub balance: u128,
    pub minimum_balance_for_rent_exemption: u128,
    pub nonce: Option<String>,
    pub lamports_per_signature: Option<u128>,
...
pub struct CliEpochReward {
    ...
    pub amount: u128,       // lamports
    pub post_balance: u128, // lamports
...
pub struct CliStakeState {
    ...
    pub credits_observed: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub delegated_stake: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rent_exempt_reserve: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub active_stake: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub activating_stake: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub deactivating_stake: Option<u128>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CliStakeHistoryEntry {
    ...
    pub activating_stake: u128,
    pub deactivating_stake: u128,
}
...
pub struct CliEpochVotingHistory {
    ...
    pub credits_earned: u128,
    pub credits: u128,
    pub prev_credits: u128,
}
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        for account in &self.accounts {
            writeln!(
                ...
                "{:<44}  {}",
                account.address,
                &format!("{} HC", lamports_to_hc(account.lamports))
            )?;
        }
        Ok(())
    }
...
impl fmt::Display for CliSupply {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        writeln_name_value(f, "Total:", &format!("{} HC", lamports_to_hc(self.total)))?;
        writeln_name_value(
            f,
            "Circulating:",
            &format!("{} HC", lamports_to_hc(self.circulating)),
        )?;
        writeln_name_value(
            f,
            "Non-Circulating:",
            &format!("{} HC", lamports_to_hc(self.non_circulating)),
        )?;
...
pub fn return_signers(
    ...
    return_signers_with_config(tx, outhuione_format, &ReturnSignersConfig::default())
}
...
pub fn return_signers_with_config(
    ...
    Ok(outhuione_format.formatted_string(&cli_command))
}
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        if !self.encoded_confirmed_block.rewards.is_empty() {
            ...
            writeln!(
                ...
                "Total Rewards: {}◎{:<12.9}",
                sign,
                lamports_to_hc(total_rewards.unsigned_abs() as u128)
            )?;
        }
...
mod tests {
    ...
    fn test_return_signers() {
        ...
        BwcCBQMEBgIEBAAAAAUCAQMUAgAAACoAAAAAAAAAAAAAAAAAAAA="
            .to_string();
    ...
    #[test]
    fn test_verbose_quiet_outhuione_formats() {
    ...
    #[test]
    fn test_outhuione_format_from_matches() {
        ...
        assert_eq!(
            OutputFormat::from_matches(&matches, "outhuione_format", false),
            OutputFormat::Json
        );
        assert_eq!(
            OutputFormat::from_matches(&matches, "outhuione_format", true),
            OutputFormat::Json
        );
