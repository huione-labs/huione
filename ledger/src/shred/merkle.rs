...
const MERKLE_HASH_PREFIX_LEAF: &[u8] = b"\x00PUT_MERKLE_SHREDS_LEAF";
const MERKLE_HASH_PREFIX_NODE: &[u8] = b"\x01PUT_MERKLE_SHREDS_NODE";
...
impl<'a> ShredTrait<'a> for ShredData {
    ...
    fn from_payload(mut payload: Vec<u8>) -> Result<Self, Error> {
        // see: https://github.com/huione-labs/huione/pull/10109
