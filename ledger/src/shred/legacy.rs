use {
    ...
    huione_perf::packet::deserialize_from_with_limit,
    huione_sdk::{clock::Slot, signature::Signature},
...
impl<'a> Shred<'a> for ShredData {
    ...
    fn from_payload(mut payload: Vec<u8>) -> Result<Self, Error> {
        ...
        // https://github.com/huione-labs/huione/pull/10109
        // https://github.com/huione-labs/huione/pull/16602
...
mod test {
    ...
    fn test_sanitize_coding_shred() {
        ...
        // shred has index > u32::MAX should fail.
        {
            ...
            // Decreasing the number of num_coding_shreds will huione it within
            // the allowed limit.
