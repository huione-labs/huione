...
then about 1,000 lines of changes is about the most you should ask a HUIONE
...
is ready to be integrated, the HUIONE maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the HUIONE
...
HUIONE's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.huione.com/proposals/accepted-design-proposals)
section of the HUIONE docs.  Here's the full process:
