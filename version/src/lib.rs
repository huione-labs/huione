...
use {
    ...
    huione_sdk::{sanitize::Sanitize, serde_varint},
...
impl Default for Version {
    fn default() -> Self {
        let feature_set = u32::from_le_bytes(
            huione_sdk::feature_set::ID.as_ref()[..4]
                .try_into()
                .unwrap(),
        );
        Self {
            ...
            client: u16::try_from(ClientId::HuioneLabs).unwrap(),
        }
    }
}
...
mod test {
    ...
    #[test]
    fn test_client_id() {
        assert_eq!(ClientId::from(0u16), ClientId::HuioneLabs);
        ...
        assert_eq!(u16::try_from(ClientId::HuioneLabs), Ok(0u16));
