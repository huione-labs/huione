use {
    ...
    huione_rpc_client_api::client_error::{Error as ClientError, Result as ClientResult},
    huione_sdk::{
        commitment_config::CommitmentConfig, message::Message, native_token::lamports_to_hc,
        pubkey::Pubkey,
    },
};
...
mod tests {
    use {
        ...
        huione_sdk::system_instruction,
        std::collections::HashMap,
    };

    #[test]
    fn test_check_account_for_fees() {
        let account_balance = 1u128;
