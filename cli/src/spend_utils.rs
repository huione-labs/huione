use {
    ...
    clap::ArgMatches,
    huione_clap_utils::{input_parsers::lamports_of_hc, offline::SIGN_ONLY_ARG},
...
impl Default for SpendAmount {
    fn default() -> Self {
        Self::Some(u128::default())
    }
}

impl SpendAmount {
    pub fn new(amount: Option<u128>, sign_only: bool) -> Self {
        match amount {
    ...
    pub fn new_from_matches(matches: &ArgMatches<'_>, name: &str) -> Self {
        let amount = lamports_of_hc(matches, name);
