    ...
    fn nonce_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-nonce-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help("The amount to load the nonce account with, in HC; accepts keyword ALL"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-nonce-account")
                .about("Withdraw HC from the nonce account")
                .arg(
                    pubkey!(Arg::with_name("nonce_account_pubkey")
                        .index(1)
                        .value_name("NONCE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .required(true),
                        "The account to which the HC should be transferred. "),
                )
                .arg(
                    Arg::with_name("amount")
                        .index(3)
                        ...
                        .required(true)
                        .validator(is_amount)
                        .help("The amount to withdraw from the nonce account, in HC"),
                )
                .arg(nonce_authority_arg())
                .arg(memo_arg())
                .arg(compute_unit_price_arg()),
...
pub fn process_show_nonce_account(
    ...
    let print_account = |data: Option<&nonce::state::Data>| {
        ...
        Ok(config.outhuione_format.formatted_string(&nonce_account))
    };
    match state_from_account(&nonce_account)? {
...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = huione_sdk::pubkey::new_rand();
        ...
        let new_nonce_authority = huione_sdk::pubkey::new_rand();
        let data = Versions::new(State::Initialized(nonce::state::Data::new(
            new_nonce_authority,
            durable_nonce,
            0,
