use {
    ...
    huione_cli_output::{CliAddressLookupTable, CliAddressLookupTableCreated, OutputFormat},
...
fn test_cli_create_extend_and_freeze_address_lookup_table() {
    ...
    config.outhuione_format = OutputFormat::JsonCompact;

    // Airdrop HC for transaction fees
    config.command = CliCommand::Airdrop {
        pubkey: None,
        lamports: 10 * LAMPORTS_PER_HC,
    };
