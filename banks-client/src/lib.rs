...
pub use {
    ...
    huione_banks_interface::{BanksClient as TarpcClient, TransactionStatus},
};
use {
    borsh::BorshDeserialize,
    futures::{future::join_all, Future, FutureExt, TryFutureExt},
    huione_banks_interface::{
...
impl BanksClient {
    ...
    pub fn get_balance_with_commitment(
        ...
        address: Pubkey,
        commitment: CommitmentLevel,
    ) -> impl Future<Output = Result<u128, BanksClientError>> + '_ {
        self.get_account_with_commitment_and_context(context::current(), address, commitment)
    ...
    pub fn get_fee_for_message(
        &mut self,
        message: Message,
    ) -> impl Future<Output = Result<Option<u128>, BanksClientError>> + '_ {
