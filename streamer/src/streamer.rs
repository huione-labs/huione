...
use {
    ...
    histogram::Histogram,
    itertools::Itertools,
    huione_sdk::{packet::Packet, pubkey::Pubkey, timing::timestamp},
    std::{
        cmp::Reverse,
        collections::HashMap,
...
pub struct StakedNodes {
    stakes: Arc<HashMap<Pubkey, u128>>,
    overrides: HashMap<Pubkey, u128>,
    total_stake: u128,
    max_stake: u128,
    min_stake: u128,
}
...
impl StakedNodes {
    pub fn new(stakes: Arc<HashMap<Pubkey, u128>>, overrides: HashMap<Pubkey, u128>) -> Self {
        let values = stakes
            .iter()
    ...
    pub fn get_node_stake(&self, pubkey: &Pubkey) -> Option<u128> {
        self.overrides
            .get(pubkey)
    ...
    #[inline]
    pub(super) fn min_stake(&self) -> u128 {
        self.min_stake
    }

    #[inline]
    pub(super) fn max_stake(&self) -> u128 {
        self.max_stake
    }
}
