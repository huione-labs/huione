...
extern crate huione_core;
extern crate test;

use {
    crossbeam_channel::unbounded,
    log::*,
    huione_core::retransmit_stage::retransmitter,
...
// the case since https://github.com/huione-labs/huione/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // huione_rpc::max_slots::MaxSlots
        None,
    );
