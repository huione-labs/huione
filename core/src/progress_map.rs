use {
    ...
    huione_ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming},
    huione_program_runtime::{report_execute_timings, timings::ExecuteTimingType},
    huione_runtime::{bank::Bank, bank_forks::BankForks, vote_account::VoteAccountsHashMap},
    huione_sdk::{clock::Slot, hash::Hash, pubkey::Pubkey},
    std::{
...
impl ValidatorStakeInfo {
    pub fn new(validator_vote_pubkey: Pubkey, stake: u128, total_epoch_stake: u128) -> Self {
        Self {
...
pub struct PropagatedStats {
    ...
    pub propagated_validators_stake: u128,
...
impl PropagatedStats {
    pub fn add_vote_pubkey(&mut self, vote_pubkey: Pubkey, stake: u128) {
...
mod test {
    use {
        super::*,
        huione_runtime::vote_account::VoteAccount,
        huione_sdk::account::{Account, AccountSharedData},
    };
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = huione_sdk::pubkey::new_rand();
        ...
        vote_pubkey = huione_sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(huione_sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = huione_sdk::pubkey::new_rand();
        ...
        // shouldn't increase
        node_pubkey = huione_sdk::pubkey::new_rand();
        stats.add_node_pubkey_internal(&node_pubkey, &vote_account_pubkeys, &epoch_vote_accounts);
        assert!(stats.propagated_node_ids.contains(&node_pubkey));
        assert_eq!(
            stats.propagated_validators_stake,
        ...
        assert_eq!(
            stats.propagated_validators_stake,
            2 * staked_vote_accounts as u128
        );
    }
