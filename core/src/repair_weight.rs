use {
    ...
    huione_runtime::epoch_stakes::EpochStakes,
    huione_sdk::{
        clock::Slot,
...
impl RepairWeight {
    ...
    fn get_best_orphans(
        ...
        let mut stake_weighted_trees: Vec<(Slot, u128)> = self
            .trees
            .iter()
            .map(|(slot, tree)| {
                (
    ...
    pub fn get_popular_pruned_forks(
        ...
        for (pruned_root, pruned_tree) in self.pruned_trees.iter() {
            ...
            let duplicate_confirmed_threshold =
                ((min_total_stake as f64) * DUPLICATE_THRESHOLD) as u128;
    ...
    // Heavier, smaller slots come first
    fn sort_by_stake_weight_slot(slot_stake_voted: &mut [(Slot, u128)]) {
...
mod test {
    use {
        ...
        huione_runtime::{bank::Bank, bank_utils, contains::Contains},
    ...
    fn test_get_popular_pruned_forks() {
        ...
        // For the last pruned tree we leave 100 stake on 23 and 22 and huione 600 stake on 20. We
