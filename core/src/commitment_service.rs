use {
    ...
    huione_rpc::rpc_subscriptions::RpcSubscriptions,
    huione_runtime::{
        bank::Bank,
...
fn get_highest_super_majority_root(mut rooted_stake: Vec<(Slot, u128)>, total_stake: u128) -> Slot {
...
impl AggregateCommitmentService {
        ...
        (
            ...
            Self {
                t_commitment: Builder::new()
                    .name("huioneAggCommitSvc".to_string())
                    .spawn(move || loop {
    ...
    pub fn aggregate_commitment(
        ancestors: &[Slot],
        bank: &Bank,
    ) -> (HashMap<Slot, BlockCommitment>, Vec<(Slot, u128)>) {
        ...
        let mut rooted_stake: Vec<(Slot, u128)> = Vec::new();
    ...
    fn aggregate_commitment_for_vote_account(
        ...
        rooted_stake: &mut Vec<(Slot, u128)>,
...
mod tests {
    use {
        super::*,
        huione_ledger::genesis_utils::{create_genesis_config, GenesisConfigInfo},
        huione_runtime::{
            accounts_background_service::AbsRequestSender,
            bank_forks::BankForks,
            genesis_utils::{create_genesis_config_with_vote_accounts, ValidatorVoteKeypairs},
        },
        huione_sdk::{account::Account, pubkey::Pubkey, signature::Signer},
    ...
    fn test_aggregate_commitment_validity() {
        ...
        let sk1 = huione_sdk::pubkey::new_rand();
        let pk1 = huione_sdk::pubkey::new_rand();
        let mut vote_account1 =
            vote_state::create_account(&pk1, &huione_sdk::pubkey::new_rand(), 0, 100);
        let stake_account1 =
            stake_state::create_account(&sk1, &pk1, &vote_account1, &genesis_config.rent, 100);
        let sk2 = huione_sdk::pubkey::new_rand();
        let pk2 = huione_sdk::pubkey::new_rand();
        let mut vote_account2 =
            vote_state::create_account(&pk2, &huione_sdk::pubkey::new_rand(), 0, 50);
        let stake_account2 =
            stake_state::create_account(&sk2, &pk2, &vote_account2, &genesis_config.rent, 50);
        let sk3 = huione_sdk::pubkey::new_rand();
        let pk3 = huione_sdk::pubkey::new_rand();
        let mut vote_account3 =
            vote_state::create_account(&pk3, &huione_sdk::pubkey::new_rand(), 0, 1);
        ...
        let sk4 = huione_sdk::pubkey::new_rand();
        let pk4 = huione_sdk::pubkey::new_rand();
        let mut vote_account4 =
            vote_state::create_account(&pk4, &huione_sdk::pubkey::new_rand(), 0, 1);
