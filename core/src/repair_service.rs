...
#[cfg(test)]
use {
    crate::duplicate_repair_status::DuplicateSlotRepairStatus, huione_ledger::shred::Nonce,
    huione_sdk::clock::DEFAULT_MS_PER_SLOT,
};
use {
    crate::{
    ...
    huione_streamer::sendmmsg::{batch_send, SendPktsError},
    std::{
...
impl RepairService {
    ...
    pub fn new(
        ...
        let t_repair = {
            ...
            Builder::new()
                .name("huioneRepairSvc".to_string())
                .spawn(move || {
                    Self::run(
                        &blockstore,
                        &exit,
...
mod test {
    use {
        super::*,
        huione_gossip::{cluster_info::Node, contact_info::ContactInfo},
        huione_ledger::{
            blockstore::{
