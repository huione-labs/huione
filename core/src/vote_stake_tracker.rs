use {huione_sdk::pubkey::Pubkey, std::collections::HashSet};
    ...
    pub fn add_vote_pubkey(
        ...
        if is_new {
            ...
            let reached_threshold_results: Vec<bool> = thresholds_to_check
                .iter()
                .map(|threshold| {
                    let threshold_stake = (total_stake as f64 * threshold) as u128;
...
#[cfg(test)]
mod test {
    use {super::*, huione_runtime::commitment::VOTE_THRESHOLD_SIZE};
