...
use {
    ...
    huione_quic_client::{QuicConfig, QuicConnectionManager, QuicPool},
    huione_rpc_client::rpc_client::RpcClient,
    huione_rpc_client_api::config::RpcProgramAccountsConfig,
    huione_sdk::{
        account::Account,
    ...
    huione_thin_client::thin_client::ThinClient as BackendThinClient,
    huione_udp_client::{UdpConfig, UdpConnectionManager, UdpPool},
...
impl ThinClient {
    ...
    dispatch!(pub fn poll_get_balance(&self, pubkey: &Pubkey) -> TransportResult<u128>);
    ...
    dispatch!(pub fn wait_for_balance(&self, pubkey: &Pubkey, expected_balance: Option<u128>) -> Option<u128>);
...
impl SyncClient for ThinClient {
    ...
    dispatch!(fn get_balance(&self, pubkey: &Pubkey) -> TransportResult<u128>);
    ...
    dispatch!(fn get_minimum_balance_for_rent_exemption(&self, data_len: usize) -> TransportResult<u128>);
    ...
    dispatch!(fn get_fee_for_message(&self, message: &Message) -> TransportResult<u128>);
}
