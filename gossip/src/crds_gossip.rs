    ...
    crds.get_nodes()
        .filter_map(|value| {
            ...
            if value.local_timestamp < active_cutoff {
                ...
                if stake == 0u128 || !rng.gen_ratio(1, 16) {
                    return None;
                }
            }
            Some(node)
...
pub(crate) fn dedup_gossip_addresses(
    ...
    stakes: &HashMap<Pubkey, u128>,
) -> HashMap</*gossip:*/ SocketAddr, (/*stake:*/ u128, ContactInfo)> {
    nodes
        .into_iter()
...
mod test {
    use {
        ...
        huione_sdk::{hash::hash, timing::timestamp},
    };
    ...
    fn test_prune_errors() {
        ...
        let mut res = crds_gossip.process_prune_msg(
            ...
            now,
            now,
            &HashMap::<Pubkey, u128>::default(), // stakes
        );
