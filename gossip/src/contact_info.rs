...
pub use {
    crate::legacy_contact_info::LegacyContactInfo, huione_client::connection_cache::Protocol,
};
...
pub struct ContactInfo {
    ...
    /// URL address to which to send JSON-RPC requests
    pub rpc_url: String,
}
...
impl ContactInfo {
    pub fn new(pubkey: Pubkey, wallclock: u64, shred_version: u16) -> Self {
        Self {
            ...
            shred_version,
            version: huione_version::Version::default(),
...
impl huione_frozen_abi::abi_example::AbiExample for ContactInfo {
    fn example() -> Self {
        Self {
            ...
            version: huione_version::Version::example(),
