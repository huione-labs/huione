//! lockups generator
use {
    huione_sdk::{clock::Epoch, epoch_schedule::EpochSchedule, timing::years_as_slots},
    std::time::Duration,
};
...
impl Unlock {
    ...
    pub fn amount(&self, total: u128) -> u128 {
        if self.fraction == 1.0 {
            total - (self.prev_fraction * total as f64) as u128
        } else {
            (self.fraction * total as f64) as u128 - (self.prev_fraction * total as f64) as u128
        }
    }
}
...
mod tests {
    ...
    fn test_make_lockups() {
        ...
        let total_lamports: u128 = 1_725_987_234_408_923;
