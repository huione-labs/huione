...
use {
    ...
    huione_stake_program::stake_state::create_lockup_stake_account,
};
...
fn calculate_staker_fees(genesis_config: &GenesisConfig, years: f64) -> u128 {
...
pub fn create_and_add_stakes(
    ...
    granularity: Option<u128>,
) -> u128 {
    let granularity = granularity.unwrap_or(std::u128::MAX);
    ...
    if total_lamports == 0 {
        ...
        println!("staker_fees:{}",staker_fees);
...
#[cfg(test)]
mod tests {
    use {super::*, huione_sdk::rent::Rent};
