...
//! subscriptions][spec].
//!
//! [spec]: https://docs.huione.com/developing/clients/jsonrpc-api#subscription-websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `huione-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/huione-rpc/latest/huione_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/huione-rpc/latest/huione_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use huione_pubsub_client::pubsub_client::PubsubClient;
//! use huione_rpc_client_api::config::RpcAccountInfoConfig;
//! use huione_sdk::pubkey::Pubkey;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.huione.com/";
//!
...
//! }
//! #
//! # get_account_updates(huione_sdk::pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
...
use {
    ...
    huione_account_decoder::UiAccount,
    ...
    huione_sdk::{clock::Slot, pubkey::Pubkey, signature::Signature},
    std::{
        marker::PhantomData,
        net::TcpStream,
        sync::{
    ...
    fn get_version(
        ...
        if let Ok(json_msg) = serde_json::from_str::<Map<String, Value>>(message_text) {
            if let Some(Object(version_map)) = json_msg.get("result") {
                if let Some(node_version) = version_map.get("huione-core") {
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `huione-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#blocksubscribe---unstable-disabled-by-default
    ...
    ///
    /// [`logsSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `huione-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#votesubscribe---unstable-disabled-by-default
    ...
    /// validator.
    ///
    /// [root]: https://docs.huione.com/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://docs.huione.com/developing/clients/jsonrpc-api#slotsupdatessubscribe---unstable
