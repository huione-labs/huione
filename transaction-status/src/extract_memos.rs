...
// A helper function to convert hpl_memo::v1::id() as hpl_sdk::pubkey::Pubkey to
// huione_sdk::pubkey::Pubkey
pub fn hpl_memo_id_v1() -> Pubkey {
    *MEMO_PROGRAM_ID_V1
}

// A helper function to convert hpl_memo::id() as hpl_sdk::pubkey::Pubkey to
// huione_sdk::pubkey::Pubkey
// pub fn hpl_memo_id_v3() -> Pubkey {
//     *MEMO_PROGRAM_ID_V3
// }

lazy_static! {
    static ref MEMO_PROGRAM_ID_V1: Pubkey = Pubkey::new_from_array(hpl_memo::id().to_bytes());
    // static ref MEMO_PROGRAM_ID_V3: Pubkey = Pubkey::new_from_array(hpl_memo::id().to_bytes());
}
