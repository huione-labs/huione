...
identity=$HUIONE_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$HUIONE_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$HUIONE_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
