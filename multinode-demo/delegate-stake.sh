...
stake_sol=1   # default number of HUIONE to assign as stake (1 HUIONE)
...
usage: $0 [OPTIONS] <HUIONE to stake ($stake_sol)>
...
VALIDATOR_KEYS_DIR=$HUIONE_CONFIG_DIR/validator$label
...
if ((airdrops_enabled)); then
  ...
  $huione_cli \
    "${common_args[@]}" --keypair "$HUIONE_CONFIG_DIR/faucet.json" \
