...
use {
    ...
    huione_account_decoder::{
        ...
        parse_name::{UiAddressResolveAccount, UiDomainAccount, UiDomainResolveAccount},
    },
...
/// documentation.
///
/// [`Finalized`]: huione_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: huione_sdk::commitment_config::CommitmentLevel::Processed
...
///
/// [`ClientError`]: huione_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: huione_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: huione_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: huione_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError`]: huione_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: huione_rpc_client_api::request::RpcError::RpcResponseError
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: huione_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    /// ```
    /// # use huione_rpc_client_api::client_error::Error;
    /// # use huione_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use huione_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`RpcError::ForUser`]: huione_rpc_client_api::request::RpcError::ForUser
    ...
    /// ```
    /// # use huione_rpc_client_api::client_error::Error;
    /// # use huione_rpc_client::rpc_client::{self, RpcClient};
    /// # use huione_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// # Ok::<(), Error>(())
    /// ```
    pub fn get_minimum_balance_for_rent_exemption(&self, data_len: usize) -> ClientResult<u128> {
    ...
    /// # Ok::<(), Error>(())
    /// ```
    pub fn get_balance(&self, pubkey: &Pubkey) -> ClientResult<u128> {
    ...
    /// # Ok::<(), Error>(())
    /// ```
    pub fn get_stake_minimum_delegation(&self) -> ClientResult<u128> {
    ...
    pub fn get_nft_accounts_by_owner(
        ...
        self.invoke(
            self.rpc_client
                .get_nft_accounts_by_owner(owner, token_account_filter),
        )
    }
    ...
    pub fn get_domain_accounts_by_owner(
        ...
        self.invoke(
            self.rpc_client
                .get_domain_accounts_by_owner(owner),
        )
    }
    ...
    pub fn get_domain_resolve_account(
        ...
        self.invoke(
            self.rpc_client
                .get_domain_resolve_account(domain_account, domain_resolve_account),
        )
    }
    ...
    pub fn get_domain_account(
        ...
        self.invoke(
            self.rpc_client
                .get_domain_account(domain_account),
        )
    }
    ...
    pub fn get_domain_address_account(
        ...
        self.invoke(
            self.rpc_client
                .get_domain_address_account(domain_address_account),
        )
    }
    ...
    pub fn request_airdrop(&self, pubkey: &Pubkey, lamports: u128) -> ClientResult<Signature> {
    ...
    #[allow(deprecated)]
    pub fn get_fee_for_message(&self, message: &impl SerializableMessage) -> ClientResult<u128> {
...
mod tests {
    use {
        ...
        huione_rpc_client_api::client_error::ErrorKind,
        huione_sdk::{
    ...
    fn test_get_stake_minimum_delegation() {
        let expected_minimum_delegation: u128 = 123_456_789;
        let rpc_client = RpcClient::new_mock("succeeds".to_string());
