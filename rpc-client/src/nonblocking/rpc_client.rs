...
#[allow(deprecated)]
use huione_rpc_client_api::deprecated_config::{
    RpcConfirmedBlockConfig, RpcConfirmedTransactionConfig,
    RpcGetConfirmedSignaturesForAddress2Config,
};
#[cfg(feature = "spinner")]
use {crate::spinner, huione_sdk::clock::MAX_HASH_AGE_IN_SECONDS, std::cmp::min};
use {
    crate::{
    ...
    huione_account_decoder::{
        ...
        parse_name::{NameAccountType, UiAddressResolveAccount, UiDomainAccount, UiDomainResolveAccount},
    },
    ...
    huione_vote_program::vote_state::MAX_LOCKOUT_HISTORY,
    std::{
        net::SocketAddr,
        str::FromStr,
...
/// [jsonprot]: https://docs.huione.com/developing/clients/jsonrpc-api
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://docs.huione.com/terminology#slot
/// [cl]: https://docs.huione.com/developing/clients/jsonrpc-api#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][huione_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][huione_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][huione_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][huione_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][huione_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use huione_sdk::system_transaction;
/// # use huione_rpc_client_api::client_error::Error;
/// # use huione_rpc_client::rpc_client::RpcClient;
/// # use huione_sdk::signature::{Keypair, Signer};
/// # use huione_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = huione_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
/// [`reqwest::Error`](huione_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](huione_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
impl RpcClient {
    ...
    ///
    /// ```
    /// # use huione_rpc_client::nonblocking::rpc_client::RpcClient;
    ...
    async fn get_node_version(&self) -> Result<semver::Version, RpcError> {
        ...
        if let Some(version) = &*r_node_version {
            ...
            let node_version = semver::Version::parse(&node_version.huione_core).map_err(|e| {
    ...
    #[allow(deprecated)]
    async fn maybe_map_request(&self, request: RpcRequest) -> Result<RpcRequest, RpcError> {
        Ok(request)
    }
    ...
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: huione_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: huione_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: huione_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://docs.huione.com/developing/clients/jsonrpc-api#sendtransaction
    /// [`getLatestBlockhash`]: https://docs.huione.com/developing/clients/jsonrpc-api#getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: huione_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: huione_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`getSignatureStatuses`]: https://docs.huione.com/developing/clients/jsonrpc-api#getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`err`]: huione_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: huione_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://docs.huione.com/developing/clients/jsonrpc-api#sendtransaction
    ///
    ...
    /// [`sig_verify`]: huione_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://docs.huione.com/developing/clients/jsonrpc-api#simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`RpcSimulateTransactionResult`].
    ///
    /// [`accounts`]: huione_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: huione_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://docs.huione.com/developing/clients/jsonrpc-api#gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: huione_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][huione_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    /// This method is built on the [`getSignatureStatuses`] RPC method.
    ///
    /// [`getSignatureStatuses`]: https://docs.huione.com/developing/clients/jsonrpc-api#gitsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlot`]: https://docs.huione.com/developing/clients/jsonrpc-api#getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://docs.huione.com/developing/clients/jsonrpc-api#getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    /// # use huione_rpc_client_api::client_error::Error;
    /// # use huione_rpc_client::nonblocking::rpc_client::RpcClient;
    /// # use huione_sdk::slot_history::Slot;
    /// # futures::executor::block_on(async {
    /// #     let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://docs.huione.com/developing/clients/jsonrpc-api#getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://docs.huione.com/developing/clients/jsonrpc-api#getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://docs.huione.com/developing/clients/jsonrpc-api#getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://docs.huione.com/developing/clients/jsonrpc-api#getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://docs.huione.com/developing/clients/jsonrpc-api#getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// ```
    /// # use huione_transaction_status::UiTransactionEncoding;
    /// # use huione_rpc_client_api::client_error::Error;
    /// # use huione_rpc_client::nonblocking::rpc_client::RpcClient;
    /// # futures::executor::block_on(async {
    /// #     let rpc_client = RpcClient::new_mock("succeeds".to_string());
    ...
    ///
    /// [`getBlocks`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblocks
    /// [`getConfirmedBlocks`]: https://docs.huione.com/developing/clients/jsonrpc-api#getConfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlocksWithLimit`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://docs.huione.com/developing/clients/jsonrpc-api#getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSignaturesForAddress`]: https://docs.huione.com/developing/clients/jsonrpc-api#getsignaturesforaddress
    /// [`getSignaturesForAddress2`]: https://docs.huione.com/developing/clients/jsonrpc-api#getsignaturesforaddress2
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getTransaction`]: https://docs.huione.com/developing/clients/jsonrpc-api#gettransaction
    /// [`getConfirmedTransaction`]: https://docs.huione.com/developing/clients/jsonrpc-api#getconfirmedtransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://docs.huione.com/developing/clients/jsonrpc-api#getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://docs.huione.com/developing/clients/jsonrpc-api#getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://docs.huione.com/developing/clients/jsonrpc-api#getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://docs.huione.com/developing/clients/jsonrpc-api#getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://docs.huione.com/developing/clients/jsonrpc-api#getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://docs.huione.com/developing/clients/jsonrpc-api#getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://docs.huione.com/developing/clients/jsonrpc-api#getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://docs.huione.com/developing/clients/jsonrpc-api#getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://docs.huione.com/developing/clients/jsonrpc-api#getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://docs.huione.com/developing/clients/jsonrpc-api#getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current huione version running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://docs.huione.com/developing/clients/jsonrpc-api#getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.huione_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://docs.huione.com/developing/clients/jsonrpc-api#minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getAccountInfo`]: https://docs.huione.com/developing/clients/jsonrpc-api#getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use huione_rpc_client_api::client_error::Error;
    /// # use huione_rpc_client::nonblocking::rpc_client::{self, RpcClient};
    /// # use huione_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://docs.huione.com/developing/clients/jsonrpc-api#getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://docs.huione.com/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://docs.huione.com/developing/clients/jsonrpc-api#getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://docs.huione.com/developing/clients/jsonrpc-api#getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://docs.huione.com/developing/clients/jsonrpc-api#getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    pub async fn get_minimum_balance_for_rent_exemption(
        ...
        let minimum_balance: u128 = serde_json::from_value(minimum_balance_json)
            .map_err(|err| ClientError::new_with_request(err.into(), request))?;
        trace!(
    ...
    ///
    /// [`getBalance`]: https://docs.huione.com/developing/clients/jsonrpc-api#getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # Ok::<(), Error>(())
    /// ```
    pub async fn get_balance(&self, pubkey: &Pubkey) -> ClientResult<u128> {
        Ok(self
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://docs.huione.com/developing/clients/jsonrpc-api#getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use huione_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # futures::executor::block_on(async {
    /// #     let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// #     let alice = Keypair::new();
    /// #     let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://docs.huione.com/developing/clients/jsonrpc-api#getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # Ok::<(), Error>(())
    /// ```
    pub async fn get_stake_minimum_delegation(&self) -> ClientResult<u128> {
    ...
    pub async fn get_nft_accounts_by_owner(
        ...
        Ok(self
            .get_nft_accounts_by_owner_with_commitment(
                owner,
                token_account_filter,
                self.commitment(),
            )
    ...
    pub async fn get_nft_accounts_by_owner_with_commitment(
        &self,
        owner: &Pubkey,
        token_account_filter: TokenAccountsFilter,
        commitment_config: CommitmentConfig,
        ...
        self.send(
            RpcRequest::GetNftAccountsByOwner,
            json!([owner.to_string(), token_account_filter, config]),
        )
            .await
    }

    pub async fn get_domain_accounts_by_owner(
        &self,
        owner: &Pubkey,
    ) -> ClientResult<Vec<RpcKeyedAccount>> {
        Ok(self
            .get_domain_accounts_by_owner_with_commitment(
                owner,
                self.commitment(),
            )
            .await?
    ...
    pub async fn get_domain_accounts_by_owner_with_commitment(
        &self,
        owner: &Pubkey,
        commitment_config: CommitmentConfig,
    ) -> RpcResult<Vec<RpcKeyedAccount>> {
        ...
        self.send(
            RpcRequest::GetDomainAccountsByOwner,
            json!([owner.to_string(), config]),
        )
            .await
    }

    pub async fn get_domain_resolve_account(
        &self,
        domain_account: &Pubkey,
        domain_resolve_account: &Pubkey,
    ) -> ClientResult<UiDomainResolveAccount> {
        self
            .get_domain_resolve_account_with_commitment(
                domain_account,
            ...
            .await?
            .value
            .ok_or_else(|| RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_resolve_account)).into())
    }

    pub async fn get_domain_resolve_account_with_commitment(
        &self,
        domain_account: &Pubkey,
        domain_resolve_account: &Pubkey,
        commitment_config: CommitmentConfig,
    ) -> RpcResult<Option<UiDomainResolveAccount>> {
        let config = RpcAccountInfoConfig {
            encoding: Some(UiAccountEncoding::JsonParsed),
            commitment: Some(self.maybe_map_commitment(commitment_config).await?),
            data_slice: None,
        ...
        let response = self.send(
            RpcRequest::GetDomainResolveAccount,
            json!([domain_account.to_string(), domain_resolve_account.to_string(), config]),
        ).await;
        ...
        response
            .map(|result_json: Value| {
                if result_json.is_null() {
                    return Err(
                        RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_resolve_account)).into(),
                    );
                }
                let Response {
                    context,
                ...
                trace!("Response account {:?} {:?}", domain_resolve_account, rpc_account);
                let response = {
                    if let Some(rpc_account) = rpc_account {
                        if let UiAccountData::Json(account_data) = rpc_account.data {
                            let name_account_type: NameAccountType =
                                serde_json::from_value(account_data.parsed)?;
                            if let NameAccountType::DomainResolve(resolve_account) = name_account_type {
                                return Ok(Response {
                                    context,
                                    value: Some(resolve_account),
                                });
                            }
                        }
                    }
                    Err(Into::<ClientError>::into(
                        RpcError::ForUser(
                            format!("AccountNotFound: pubkey={}", domain_resolve_account)
                        )
                    ))
                };
                response?
            ...
            .map_err(|err| {
                Into::<ClientError>::into(RpcError::ForUser(format!(
                    ...
                    domain_resolve_account, err
                )))
            })?
    }

    pub async fn get_domain_account(
        &self,
        domain_account: &Pubkey,
    ) -> ClientResult<UiDomainAccount> {
        self
            .get_domain_account_with_commitment(
                domain_account,
                self.commitment(),
            )
            .await?
            .value
            .ok_or_else(|| RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_account)).into())
    }

    pub async fn get_domain_account_with_commitment(
        &self,
        domain_account: &Pubkey,
        commitment_config: CommitmentConfig,
    ) -> RpcResult<Option<UiDomainAccount>> {
        let config = RpcAccountInfoConfig {
            encoding: Some(UiAccountEncoding::JsonParsed),
            commitment: Some(self.maybe_map_commitment(commitment_config).await?),
            data_slice: None,
        ...
        response
            .map(|result_json: Value| {
                if result_json.is_null() {
                    return Err(
                        RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_account)).into(),
                    );
                }
                let Response {
                    context,
                ...
                trace!("Response account {:?} {:?}", domain_account, rpc_account);
                let response = {
                    if let Some(rpc_account) = rpc_account {
                        if let UiAccountData::Json(account_data) = rpc_account.data {
                            let name_account_type: NameAccountType =
                                serde_json::from_value(account_data.parsed)?;
                            if let NameAccountType::Domain(domain_account) = name_account_type {
                                return Ok(Response {
                                    context,
                                    value: Some(domain_account),
                                });
                            }
                        }
                    }
                    Err(Into::<ClientError>::into(
                        RpcError::ForUser(
                            format!("AccountNotFound: pubkey={}", domain_account)
                        )
                    ))
                };
                response?
    ...
    pub async fn get_domain_address_account(
        &self,
        domain_address_account: &Pubkey,
    ) -> ClientResult<UiAddressResolveAccount> {
        self
            .get_domain_addresss_account_with_commitment(
                domain_address_account,
                self.commitment(),
            )
            .await?
            .value
            .ok_or_else(|| RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_address_account)).into())
    }

    pub async fn get_domain_addresss_account_with_commitment(
        &self,
        domain_address_puk: &Pubkey,
        commitment_config: CommitmentConfig,
    ) -> RpcResult<Option<UiAddressResolveAccount>> {
        let config = RpcAccountInfoConfig {
            encoding: Some(UiAccountEncoding::JsonParsed),
            commitment: Some(self.maybe_map_commitment(commitment_config).await?),
            data_slice: None,
        ...
        let response = self.send(
            RpcRequest::GetDomainAddressAccount,
            json!([domain_address_puk.to_string(), config]),
        ).await;
        ...
        response
            .map(|result_json: Value| {
                if result_json.is_null() {
                    return Err(
                        RpcError::ForUser(format!("AccountNotFound: pubkey={}", domain_address_puk)).into(),
                    );
                }
                let Response {
                    context,
                ...
                trace!("Response account {:?} {:?}", domain_address_puk, rpc_account);
                let response = {
                    if let Some(rpc_account) = rpc_account {
                        if let UiAccountData::Json(account_data) = rpc_account.data {
                            let name_account_type: NameAccountType =
                                serde_json::from_value(account_data.parsed)?;
                            if let NameAccountType::AddressResolve(domain_address_account) = name_account_type {
                                return Ok(Response {
                                    context,
                                    value: Some(domain_address_account),
                                });
                            }
                        }
                    }
                    Err(Into::<ClientError>::into(
                        RpcError::ForUser(
                            format!("AccountNotFound: pubkey={}", domain_address_puk)
                        )
                    ))
                };
                response?
    ...
    pub async fn request_airdrop(&self, pubkey: &Pubkey, lamports: u128) -> ClientResult<Signature> {
