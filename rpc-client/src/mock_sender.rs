        ...
        let val = match method.as_str().unwrap() {
            ...
            "sendTransaction" => {
                let signature = if self.url == "malicious" {
                    ...
                    //let tx_str = "".to_string();
