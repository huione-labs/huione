use {
    crate::{
        ...
        stake_state::{
            ...
            initialize, merge, new_warmup_cooldown_rate_epoch, redelegate, set_lockup, split, withdraw,
        },
    },
    log::*,
...
mod tests {
                ...
                (
                    *pubkey,
                    if clock::check_id(pubkey) {
                        ...
                        AccountSharedData::new(0, 0, &huione_vote_program::id())
    ...
    fn just_stake(meta: Meta, stake: u128) -> StakeState {
        StakeState::Stake(
            meta,
            Stake {
    ...
    fn test_stake_process_instruction_decode_bail(feature_set: Arc<FeatureSet>) {
        ...
        let vote_account = AccountSharedData::new(0, 0, &huione_vote_program::id());
    ...
    fn test_stake_initialize(feature_set: Arc<FeatureSet>) {
        ...
        let stake_address = huione_sdk::pubkey::new_rand();
        let stake_account = AccountSharedData::new(stake_lamports, StakeState::size_of(), &id());
        let custodian_address = huione_sdk::pubkey::new_rand();
        let lockup = Lockup {
            epoch: 1,
            unix_timestamp: 0,
    ...
    fn test_authorize(feature_set: Arc<FeatureSet>) {
        let authority_address = huione_sdk::pubkey::new_rand();
        let authority_address_2 = huione_sdk::pubkey::new_rand();
        let stake_address = huione_sdk::pubkey::new_rand();
        ...
        .unwrap();
        let to_address = huione_sdk::pubkey::new_rand();
    ...
    fn test_authorize_override(feature_set: Arc<FeatureSet>) {
        let authority_address = huione_sdk::pubkey::new_rand();
        let mallory_address = huione_sdk::pubkey::new_rand();
        let stake_address = huione_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let stake_account = AccountSharedData::new_data_with_space(
            stake_lamports,
    ...
    fn test_authorize_with_seed(feature_set: Arc<FeatureSet>) {
        let authority_base_address = huione_sdk::pubkey::new_rand();
        let authority_address = huione_sdk::pubkey::new_rand();
        let seed = "42";
    ...
    fn test_authorize_delegated_stake(feature_set: Arc<FeatureSet>) {
        ...
        .unwrap();
        let vote_address = huione_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &huione_sdk::pubkey::new_rand(), 0, 100);
        let vote_address_2 = huione_sdk::pubkey::new_rand();
        let mut vote_account_2 =
            vote_state::create_account(&vote_address_2, &huione_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_stake_delegate(feature_set: Arc<FeatureSet>) {
        ...
        transaction_accounts[1]
            .1
            .set_owner(huione_sdk::pubkey::new_rand());
        process_instruction(
            Arc::clone(&feature_set),
            &serialize(&StakeInstruction::DelegateStake).unwrap(),
            transaction_accounts.clone(),
            instruction_accounts.clone(),
            Err(huione_sdk::instruction::InstructionError::IncorrectProgramId),
        );
    ...
    fn test_redelegate_consider_balance_changes(feature_set: Arc<FeatureSet>) {
        ...
        let recipient_address = huione_sdk::pubkey::new_rand();
        let authority_address = huione_sdk::pubkey::new_rand();
        let vote_address = huione_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &huione_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_split(feature_set: Arc<FeatureSet>) {
        ...
        let split_to_address = huione_sdk::pubkey::new_rand();
    ...
    fn test_withdraw_stake(feature_set: Arc<FeatureSet>) {
        ...
        process_instruction(
            Arc::clone(&feature_set),
            &serialize(&StakeInstruction::Withdraw(u128::MAX - 10)).unwrap(),
            transaction_accounts.clone(),
            instruction_accounts.clone(),
            Err(InstructionError::InsufficientFunds),
        );
    ...
    fn test_set_lockup(feature_set: Arc<FeatureSet>) {
        let custodian_address = huione_sdk::pubkey::new_rand();
        let authorized_address = huione_sdk::pubkey::new_rand();
        let stake_address = huione_sdk::pubkey::new_rand();
        let minimum_delegation = crate::get_minimum_delegation(&feature_set);
        let stake_lamports = minimum_delegation;
        let stake_account = AccountSharedData::new_data_with_space(
    ...
    fn test_merge(feature_set: Arc<FeatureSet>) {
        let stake_address = huione_sdk::pubkey::new_rand();
        let merge_from_address = huione_sdk::pubkey::new_rand();
        let authorized_address = huione_sdk::pubkey::new_rand();
    ...
    fn test_merge_incorrect_authorized_staker(feature_set: Arc<FeatureSet>) {
        ...
        let merge_from_address = huione_sdk::pubkey::new_rand();
        let authorized_address = huione_sdk::pubkey::new_rand();
        let wrong_authorized_address = huione_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let mut instruction_accounts = vec![
            AccountMeta {
                pubkey: stake_address,
    ...
    fn test_merge_active_stake(feature_set: Arc<FeatureSet>) {
        ...
        loop {
            ...
            let delta =
                activating.min((effective as f64 * warmup_cooldown_rate(clock.epoch, new_warmup_cooldown_rate_epoch)) as u128);
            effective += delta;
            activating -= delta;
            stake_history.add(
                clock.epoch,
        ...
        loop {
            clock.epoch += 1;
            let delta =
                deactivating.min((effective as f64 * warmup_cooldown_rate(clock.epoch, new_warmup_cooldown_rate_epoch)) as u128);
            effective -= delta;
            deactivating -= delta;
    ...
    fn test_stake_process_instruction_error_ordering(feature_set: Arc<FeatureSet>) {
        ...
        let good_stake_account = AccountSharedData::new(u128::MAX, StakeState::size_of(), &id());
    ...
    fn test_redelegate(feature_set: Arc<FeatureSet>) {
        ...
        // Success: normal case
        //
        let outhuione_accounts = process_instruction_redelegate(
            &stake_address,
            &stake_account,
            &authorized_staker,
            &new_vote_address,
        ...
        assert_eq!(outhuione_accounts[0].lamports(), rent_exempt_reserve);
        if let StakeState::Stake(meta, stake) =
            outhuione_accounts[0].borrow().deserialize_data().unwrap()
        {
            ...
            panic!("Invalid outhuione_accounts[0] data");
        }
        assert_eq!(
            outhuione_accounts[1].lamports(),
            minimum_delegation + rent_exempt_reserve
        );
        if let StakeState::Stake(meta, stake) =
            outhuione_accounts[1].borrow().deserialize_data().unwrap()
        {
            assert_eq!(meta.rent_exempt_reserve, rent_exempt_reserve);
            ...
            panic!("Invalid outhuione_accounts[1] data");
        }
        ...
        let deactivated_stake_accounts = [
            (
                ...
                {
                    let mut deactivated_stake_account = outhuione_accounts[0].clone();
        ...
        assert_eq!(outhuione_accounts[0].lamports(), rent_exempt_reserve + 42);
