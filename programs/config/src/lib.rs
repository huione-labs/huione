...
pub use huione_sdk::config::program::id;
#[allow(deprecated)]
use huione_sdk::stake::config::Config as StakeConfig;
use {
...
// TODO move ConfigState into `huione_program` to implement trait locally
#[allow(deprecated)]
