...
pub use huione_program::vote::state::{vote_state_versions::*, *};
use {
    log::*,
    serde_derive::{Deserialize, Serialize},
    huione_metrics::datapoint_debug,
    huione_program::vote::{error::VoteError, program::id},
    huione_sdk::{
...
#[frozen_abi(digest = "2rPJuX4vydTE2d7N4HyYjRSW8EDBLWgU14epGDWgQzCz")]
...
pub fn process_new_vote_state(
    ...
    let mut finalized_slot_count = 1_u128;
...
mod tests {
    ...
    //     let withdrawer_pubkey = huione_sdk::pubkey::new_rand();
    ...
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&huione_sdk::pubkey::new_rand(), 0, 1, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    //     vote_state.increment_credits(1, 200);
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&huione_sdk::pubkey::new_rand(), 1, 2, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    //     vote_state.increment_credits(2, 300);
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&huione_sdk::pubkey::new_rand(), 2, 3, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    ...
    fn test_vote_double_lockout_after_expiration() {
        let voter_pubkey = huione_sdk::pubkey::new_rand();
    ...
    fn test_process_missed_votes() {
        let account_a = huione_sdk::pubkey::new_rand();
        let mut vote_state_a = vote_state_new_for_test(&account_a);
        let account_b = huione_sdk::pubkey::new_rand();
