...
impl<'a> CallerAccount<'a> {
    ...
    fn from_account_info(
        ...
        let lamports = {
            ...
            translate_type_mut::<u128>(memory_mapping, *ptr, invoke_context.get_check_aligned())?
        };
    ...
    fn from_sol_account_info(
        ...
        let lamports = translate_type_mut::<u128>(
            memory_mapping,
