...
impl ::huione_frozen_abi::abi_example::AbiExample for ComputeBudget {
    fn example() -> Self {
...
impl ComputeBudget {
    ...
    pub fn process_instructions<'a>(
            ...
            if compute_budget::check_id(program_id) {
                ...
                match try_from_slice_unchecked(&instruction.data) {
                    Ok(ComputeBudgetInstruction::RequestUnitsDeprecated {
                        ...
                        prioritization_fee =
                            Some(PrioritizationFeeType::Deprecated(additional_fee));
                    }
        ...
        Ok(prioritization_fee
            .map(|fee_type| PrioritizationFeeDetails::new(fee_type, self.compute_unit_limit as u128))
            .unwrap_or_default())
    }
}
    ...
    fn test_process_instructions() {
        ...
        test!(
            &[
                ...
                ComputeBudgetInstruction::request_heap_frame(MAX_HEAP_FRAME_BYTES),
                ComputeBudgetInstruction::set_compute_unit_limit(MAX_COMPUTE_UNIT_LIMIT),
                ComputeBudgetInstruction::set_compute_unit_price(u128::MAX),
            ],
            Ok(PrioritizationFeeDetails::new(
                PrioritizationFeeType::ComputeUnitPrice(u128::MAX),
                MAX_COMPUTE_UNIT_LIMIT as u128,
            )),
            ComputeBudget {
                compute_unit_limit: MAX_COMPUTE_UNIT_LIMIT as u64,
                heap_size: Some(MAX_HEAP_FRAME_BYTES as usize),
