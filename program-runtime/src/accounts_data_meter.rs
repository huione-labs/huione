...
/// 256 GB was chosen because it is the RAM amount listed under Hardware Recommendations on
/// [Validator Requirements](https://docs.huione.com/running-validator/validator-reqs), and
/// validators often huione the ledger on a RAM disk (i.e. tmpfs).
pub const MAX_ACCOUNTS_DATA_LEN: u64 = 256_000_000_000;
