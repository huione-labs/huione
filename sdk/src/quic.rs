//! Definitions related to HC over QUIC.
...
/// set to this ratio times [`huione_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_UNSTAKED_RECEIVE_WINDOW_RATIO: u128 = 1;

/// The receive window for QUIC connection from minimum staked nodes is
/// set to this ratio times [`huione_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_MIN_STAKED_RECEIVE_WINDOW_RATIO: u128 = 2;

/// The receive window for QUIC connection from maximum staked nodes is
/// set to this ratio times [`huione_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_MAX_STAKED_RECEIVE_WINDOW_RATIO: u128 = 10;
