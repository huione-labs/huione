...
//! provided by `huione-program`, see that crate's documentation for an
//! overview.
//!
//! [`huione-program`]: https://docs.rs/huione-program
//!
...
//! Such crates include:
//!
//! - [`huione-client`] - For interacting with a Solana node via the [JSON-RPC API][json].
//! - [`huione-cli-config`] - Loading and saving the Solana CLI configuration file.
//! - [`huione-clap-utils`] - Routines for setting up the CLI using [`clap`], as
//!   used by the Solana CLI. Includes functions for loading all types of
//!   signers supported by the CLI.
//!
//! [`solana-client`]: https://docs.rs/huione-client
//! [`solana-cli-config`]: https://docs.rs/huione-cli-config
//! [`solana-clap-utils`]: https://docs.rs/huione-clap-utils
//! [json]: https://docs.huione.com/developing/clients/jsonrpc-api
...
// Allows macro expansion of `use ::huione_sdk::*` to work within this crate
extern crate self as huione_sdk;

#[cfg(feature = "full")]
pub use signer::signers;
// These huione_program imports could be *-imported, but that causes a bunch of
// confusing duplication in the docs due to a rustdoc bug. #26211
#[cfg(not(target_os = "solana"))]
pub use huione_program::program_stubs;
...
pub use huione_sdk_macro::declare_deprecated_id;
...
/// use std::str::FromStr;
/// use huione_sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use huione_sdk::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use huione_sdk_macro::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use huione_sdk_macro::pubkey;
/// Convenience macro to define multiple static public keys.
pub use huione_sdk_macro::pubkeys;
#[rustversion::since(1.46.0)]
pub use huione_sdk_macro::respan;

// Unused `huione_sdk::program_stubs!()` macro retained for source backwards compatibility with older programs
#[macro_export]
#[deprecated(
    since = "1.4.3",
