...
//!
//! [na]: https://docs.huione.com/implemented-proposals/durable-tx-nonces
//!
...
//!
//! [rent exempt]: https://docs.huione.com/developing/programming-model/accounts#rent-exemption
//!
...
pub enum SystemError {
    ...
    AccountAlreadyInUse,
    #[error("account does not have enough HC to perform the operation")]
...
pub fn instruction_to_nonce_error(error: &InstructionError) -> Option<NonceError> {
    match error {
...
#[frozen_abi(digest = "FzvRtvWMz72vE4XX9aKajDRiAceE8oFFRtbKbFcyGk3v")]
...
pub enum SystemInstruction {
    ...
    ///
    /// The `u128` parameter is the lamports to withdraw, which must leave the
    /// account balance above the rent exempt reserve or at zero.
    WithdrawNonceAccount(u128),
...
///
/// ```
/// # use huione_program::example_mocks::{huione_sdk, huione_rpc_client};
...
///
/// This example submits the instruction from an on-chain HC program. The
...
/// ## Example: on-chain program
///
/// This example submits the instructions from an on-chain HC program. The
...
/// # Ok::<(), anyhow::Error>(())
/// ```
pub fn transfer(from_pubkey: &Pubkey, to_pubkey: &Pubkey, lamports: u128) -> Instruction {
    let account_metas = vec![
        AccountMeta::new(*from_pubkey, true),
        AccountMeta::new(*to_pubkey, false),
    ];
...
/// # Ok::<(), anyhow::Error>(())
/// ```
pub fn transfer_many(from_pubkey: &Pubkey, to_lamports: &[(Pubkey, u128)]) -> Vec<Instruction> {
    to_lamports
        .iter()
...
///
/// Standard HC transactions include a [recent blockhash][rbh] (sometimes
/// referred to as a _[nonce]_). During execution the HC runtime verifies
...
///
/// [dtn]: https://docs.huione.com/implemented-proposals/durable-tx-nonces
...
///
/// ```
/// # use huione_program::example_mocks::huione_sdk;
/// # use huione_program::example_mocks::huione_rpc_client;
/// use huione_rpc_client::rpc_client::RpcClient;
/// use huione_sdk::{
/// #   pubkey::Pubkey,
///     signature::{Keypair, Signer},
...
/// in the first position, the HC runtime recognizes the transaction as one
...
/// [`huione_rpc_client_nonce_utils::data_from_account`][dfa] function.
///
...
/// [dfa]: https://docs.rs/huione-rpc-client-nonce-utils/latest/huione_rpc_client_nonce_utils/fn.data_from_account.html
///
/// # Required signers
///
...
/// # use huione_program::example_mocks::huione_sdk;
/// # use huione_program::example_mocks::huione_rpc_client;
/// # use huione_program::example_mocks::huione_rpc_client_nonce_utils;
/// use huione_rpc_client::rpc_client::RpcClient;
/// use huione_sdk::{
///     message::Message,
///     pubkey::Pubkey,
...
///     #   lamports: 1,
///     #   data: vec![0],
///     #   owner: huione_sdk::system_program::ID,
///     #   executable: false,
///     #   rent_epoch: 1,
///     # });
///     let nonce_account = client.get_account(nonce_account_pubkey)?;
///     let nonce_data = huione_rpc_client_nonce_utils::data_from_account(&nonce_account)?;
...
///
/// [rent exemption]: https://docs.huione.com/developing/programming-model/accounts#rent-exemption
///
