//! Types for directing the execution of HC programs.
//!
//! Every invocation of a HC program executes a single instruction, as
...
//! the HC runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the HC runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across HC software versions.
    ///
...
/// A directive for a single invocation of a HC program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by HC
...
/// construction.
///
/// While HC is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the HC runtime coalesces all accounts used
...
#[doc(hidden)]
pub fn checked_add(a: u128, b: u128) -> Result<u128, InstructionError> {
...
///
/// Note that because the HC runtime schedules parallel transaction
...
/// which is the core of a HC transaction. It is created during the
