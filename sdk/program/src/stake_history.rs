...
//!
//! [sv]: https://docs.huione.com/developing/runtime-facilities/sysvars#stakehistory
//!
...
pub struct StakeHistoryEntry {
    pub effective: u128,    // effective stake at this epoch
    pub activating: u128,   // sum of portion of stakes not fully warmed up
    pub deactivating: u128, // requested to be cooled down, not fully deactivated yet
}

impl StakeHistoryEntry {
    pub fn with_effective(effective: u128) -> Self {
        Self {
            effective,
            ..Self::default()
        }
    ...
    pub fn with_effective_and_activating(effective: u128, activating: u128) -> Self {
        Self {
            effective,
            activating,
            ..Self::default()
    ...
    pub fn with_deactivating(deactivating: u128) -> Self {
        Self {
...
mod tests {
    ...
    fn test_stake_history() {
        ...
        for i in 0..MAX_ENTRIES as u128 + 1 {
            stake_history.add(
                i as u64,
                StakeHistoryEntry {
                    activating: i,
