...
use {
    crate::{
        ...
        program_error::ProgramError, program_memory::huione_memset, pubkey::Pubkey,
    },
    std::{
...
impl<'a> AccountInfo<'a> {
    ...
    pub fn try_lamports(&self) -> Result<u128, ProgramError> {
    ...
    pub fn try_borrow_lamports(&self) -> Result<Ref<&mut u128>, ProgramError> {
        self.lamports
            .try_borrow()
            .map_err(|_| ProgramError::AccountBorrowFailed)
    }

    pub fn try_borrow_mut_lamports(&self) -> Result<RefMut<&'a mut u128>, ProgramError> {
        self.lamports
            .try_borrow_mut()
            .map_err(|_| ProgramError::AccountBorrowFailed)
    }
    ...
    /// `huione_program::entrypoint::MAX_PERMITTED_DATA_INCREASE` bytes.
    ///
    ...
    pub fn realloc(&self, new_len: usize, zero_init: bool) -> Result<(), ProgramError> {
        ...
        if zero_init {
            ...
            if len_increase > 0 {
                huione_memset(&mut data[old_len..], 0, len_increase);
            }
        }
