...
define_syscall!(fn sol_curve_group_op(curve_id: u64, group_op: u64, left_inhuione_addr: *const u8, right_inhuione_addr: *const u8, result_point_addr: *mut u8) -> u64);
...
define_syscall!(fn sol_alt_bn128_group_op(group_op: u64, input: *const u8, inhuione_size: u64, result: *mut u8) -> u64);
