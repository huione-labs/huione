...
pub mod huione_rpc_client {
    pub mod rpc_client {
        use {
            super::super::{
                huione_rpc_client_api::client_error::Result as ClientResult,
                huione_sdk::{
        ...
        impl RpcClient {
            ...
            pub fn get_balance(&self, _pubkey: &Pubkey) -> ClientResult<u128> {
                Ok(0)
            }
        }
    }
...
pub mod huione_rpc_client_nonce_utils {
    use {
        super::huione_sdk::{account::ReadableAccount, account_utils::StateMut, pubkey::Pubkey},
...
/// solana-program.
///
/// This lets examples in huione-program appear to be written as client
/// programs.
pub mod huione_sdk {
    pub use crate::{
...
pub mod huione_address_lookup_table_program {
