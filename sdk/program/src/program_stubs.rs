//! Implementations of syscalls used when `huione-program` is built for non-SBF targets.
...
pub(crate) fn sol_log_128(arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
    sol_log(&format!(
        "{:#x}, {:#x}, {:#x}, {:#x}, {:#x}",
