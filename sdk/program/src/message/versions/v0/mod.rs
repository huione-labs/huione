//! A future HC message format.
//!
//! This crate defines two versions of `Message` in their own modules:
//! [`legacy`] and [`v0`]. `legacy` is the current version as of HC 1.10.0.
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`huione_address_lookup_table_program`], [`huione_rpc_client`], [`huione_sdk`], and [`anyhow`] crates.
    ///
    /// [`huione_address_lookup_table_program`]: https://docs.rs/solana-address-lookup-table-program
    /// [`huione_rpc_client`]: https://docs.rs/solana-rpc-client
    /// [`huione_sdk`]: https://docs.rs/solana-sdk
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use huione_program::example_mocks::{
    /// #     huione_address_lookup_table_program,
    /// #     huione_rpc_client,
    /// #     huione_sdk,
    /// # };
    /// # use std::borrow::Cow;
    ...
    /// use anyhow::Result;
    /// use huione_address_lookup_table_program::state::AddressLookupTable;
    ...
    ///     #   owner: huione_address_lookup_table_program::ID,
    ///     #   executable: false,
    ///     #   rent_epoch: 1,
    ///     # });
