...
//!
//! In HC, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/huione-sdk/latest/huione-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://docs.huione.com/developing/programming-model/transactions#recent-blockhash
//!
...
//! version as of HC 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! Despite living in the `huione-program` crate, there is no way to access the
//! runtime's messages from within a HC program, and only the legacy message
//! types continue to be exposed to HC programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.huione.com/cluster/synchronization
