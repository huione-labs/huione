//! The original and current HC message format.
//!
//! This crate defines two versions of `Message` in their own modules:
//! [`legacy`] and [`v0`]. `legacy` is the current version as of HC 1.1.0.
...
//! [`v0`]: crate::message::v0
//! [future message format]: https://docs.huione.com/proposals/transactions-v2
...
/// A HC transaction message (legacy).
///
...
#[wasm_bindgen]
#[frozen_abi(digest = "FmLYNRjQ7T5jVvhmCPSeUBNZvayg7AHM2XoN2Mypt17e")]
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`huione_sdk`], [`huione_client`] and [`anyhow`] crates.
    ///
    /// [`huione_sdk`]: https://docs.rs/huione-sdk
    /// [`huione_client`]: https://docs.rs/huione-client
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use huione_program::example_mocks::huione_sdk;
    /// # use huione_program::example_mocks::huione_client;
    /// use anyhow::Result;
    ...
    ///
    /// [nonced transaction]: https://docs.huione.com/implemented-proposals/durable-tx-nonces
    ///
    ...
    /// enum BankInstruction {
    ///     Initialize,
    ///     Deposit { lamports: u128 },
    ///     Withdraw { lamports: u128 },
    /// }
    ///
    ...
    pub fn hash_raw_message(message_bytes: &[u8]) -> Hash {
        ...
        hasher.update(b"huione-tx-message-v1");
...
mod tests {
    ...
    fn test_message_hash() {
        ...
        // in this case, the domain prefix `huione-tx-message-v1` should be updated.
        ...
        assert_eq!(
            ...
            Hash::from_str("JAs6DdTkYbMNGLd2CStEBtHi6YLtTrbszMdDLCx8LUZM").unwrap()
        )
    }
}
