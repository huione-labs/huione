...
#[frozen_abi(digest = "hyv11jZBz9x1sSmNeeqo8XkDmk6WjQNpV3Kb77vAQJp")]
...
#[frozen_abi(digest = "B8ZK3N1cDs2mb88695ReUFkwZcgxj3Rnf6wv5PYLLnqq")]
#[derive(Serialize, Default, Deserialize, Debug, PartialEq, Eq, Clone, AbiExample)]
...
#[frozen_abi(digest = "2aTrHqCNpF1fsh264qmTtJ2QMNCFvedpgWskbiopcHYP")]
#[derive(Debug, Default, Serialize, Deserialize, PartialEq, Eq, Clone, AbiExample)]
pub struct VoteState {
    ...
    pub epoch_credits: Vec<(Epoch, u128, u128)>,
...
impl VoteState {
    ...
    pub fn get_rent_exempt_reserve(rent: &Rent) -> u128 {
    ...
    // pub fn credits_from<T: ReadableAccount>(account: &T) -> Option<u128> {
    ...
    pub fn commission_split(&self, on: u128) -> (u128, u128, bool) {
    ...
    pub fn increment_credits(&mut self, epoch: Epoch, credits: u128) {
    ...
    /// Each tuple of (Epoch, u128, u128) is read as (epoch, credits, prev_credits), where
    ...
    pub fn epoch_credits(&self) -> &Vec<(Epoch, u128, u128)> {
        &self.epoch_credits
    }
...
mod tests {
    ...
    fn test_vote_state_epoch_credits() {
        ...
        for epoch in 0..epochs {
            ...
            expected.push((epoch, credits, credits - epoch as u128));
        }
    ...
    fn test_vote_state_increment_credits() {
        ...
        let credits = (MAX_EPOCH_CREDITS_HISTORY + 2) as u128;
        for i in 0..credits {
    ...
    #[test]
    pub fn test_vote_size()
    {
        let vote_state = VoteStateVersions::new_current(VoteState::get_max_sized_vote_state());
        let s = serialized_size(&vote_state).unwrap() as usize;
        println!("len:{}",s);
    }
}
