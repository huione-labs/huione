...
//!
//! See also the HC [documentation on the epoch schedule sysvar][sdoc].
//!
//! [sdoc]: https://docs.huione.com/developing/runtime-facilities/sysvars#epochschedule
//!
//! # Examples
//!
...
//! # use huione_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
