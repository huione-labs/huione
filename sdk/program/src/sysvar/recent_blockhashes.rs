...
//!
//! [`getFeeForMessage`]: https://docs.huione.com/developing/clients/jsonrpc-api#getfeeformessage
//! [ccf]: https://docs.huione.com/proposals/comprehensive-compute-fees
//!
//! See also the Solana [documentation on the recent blockhashes sysvar][sdoc].
//!
//! [sdoc]: https://docs.huione.com/developing/runtime-facilities/sysvars#recentblockhashes

#![allow(deprecated)]
#![allow(clippy::integer_arithmetic)]
use {
    crate::{
        declare_deprecated_sysvar_id, fee_calculator::FeeCalculator, hash::{hash, Hash}, sysvar::Sysvar,
    },
...
impl Entry {
    pub fn new(blockhash: &Hash, lamports_per_signature: u128) -> Self {
        Self {
            blockhash: *blockhash,
...
#[derive(Clone, Debug)]
pub struct IterItem<'a>(pub u64, pub &'a Hash, pub u128);
