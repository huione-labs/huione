...
//!
//! See also the HC [documentation on the rent sysvar][sdoc].
//!
//! [sdoc]: https://docs.huione.com/developing/runtime-facilities/sysvars#rent
//!
//! # Examples
//!
...
//! }
//! #
//! # use huione_program::sysvar::SysvarId;
//! # let p = Rent::id();
//! # let l = &mut 1009200;
...
//! # use huione_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #
