...
//!
//! See also the HC [documentation on the clock sysvar][sdoc].
//!
//! [sdoc]: https://docs.huione.com/developing/runtime-facilities/sysvars#clock
//!
//! # Examples
//!
...
//! # use huione_sdk::sysvar::clock::{self, Clock};
//! # use anyhow::Result;
//! #
