...
release channels:
* https://metrics.huione.com:3000/d/monitor-edge/cluster-telemetry-edge
* https://metrics.huione.com:3000/d/monitor-beta/cluster-telemetry-beta
* https://metrics.huione.com:3000/d/monitor/cluster-telemetry
...
https://buildkite.com/huione-labs/publish-metrics-dashboard.
...
* Check out metrics to add at https://metrics.huione.com:8888/ in the data explorer.
...
```
$ export GRAFANA_API_TOKEN="an API key from https://metrics.huione.com:3000/org/apikeys"
