...
use {
    ...
    huione_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/huione-labs/huione-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(huione_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]
