...
use {
    ...
    huione_rpc_client_api::{config::RpcProgramAccountsConfig, response::Response},
    huione_sdk::{
        account::Account,
    ...
    C: NewConnectionConfig,
{
    ...
    pub fn poll_get_balance(&self, pubkey: &Pubkey) -> TransportResult<u128> {
    ...
    pub fn wait_for_balance(&self, pubkey: &Pubkey, expected_balance: Option<u128>) -> Option<u128> {
    ...
    C: NewConnectionConfig,
{
    ...
    fn get_balance(&self, pubkey: &Pubkey) -> TransportResult<u128> {
    ...
    fn get_minimum_balance_for_rent_exemption(&self, data_len: usize) -> TransportResult<u128> {
        self.rpc_client()
    ...
    fn get_fee_for_message(&self, message: &Message) -> TransportResult<u128> {
        self.rpc_client()
