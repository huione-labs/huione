...
mod tests {
    ...
    fn create_bank(lamports: u128) -> (Bank, Keypair, u128,u128) {
    ...
    fn test_new_derived_stake_account() {
        let (bank, funding_keypair, stake_rent, system_rent) = create_bank(10_000_000_000);
        ...
        let stake_authority_pubkey = huione_sdk::pubkey::new_rand();
        let withdraw_authority_pubkey = huione_sdk::pubkey::new_rand();
    ...
    fn test_authorize_stake_accounts() {
        ...
        let new_stake_authority_pubkey = huione_sdk::pubkey::new_rand();
        let new_withdraw_authority_pubkey = huione_sdk::pubkey::new_rand();
