use {
    ...
    huione_clap_utils::{
        input_parsers::{unix_timestamp_from_rfc3339_datetime,lamports_of_hc},
...
fn fee_payer_arg<'a, 'b>() -> Arg<'a, 'b> {
    huione_clap_utils::fee_payer::fee_payer_arg().required(true)
}
...
fn stake_lockup_custodian_arg<'a, 'b>() -> Arg<'a, 'b> {
    Arg::with_name("lockup_custodian")
        .long("lockup-custodian")
        .takes_value(true)
        .value_name("PUBKEY")
        .validator(is_valid_pubkey)
        .help("Set stake account lockup custodian.")
}
            ...
            SubCommand::with_name("new")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("Amount to move into the new stake accounts, in HC"),
                )
                .arg(
                    Arg::with_name("stake_authority")
                        .long("stake-authority")
                ...
                .arg(stake_lockup_custodian_arg())
...
fn parse_new_args(matches: &ArgMatches<'_>) -> NewArgs<String, String> {
    NewArgs {
        ...
        lamports: lamports_of_hc(matches, "amount").unwrap(),
        ...
        lockup_custodian: value_t!(matches, "lockup_custodian", String).ok(),
    }
}
